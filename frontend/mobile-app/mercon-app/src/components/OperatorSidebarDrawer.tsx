...
export const MENU_SECTIONS: MenuSection[] = [
  {
    ...
    items: [
      ...
      { Icon: Building2, label: '3rd Party Fleet', desc: 'Subcontractors & providers', route: '/operator/third-party' },
      { Icon: Wrench, label: 'Maintenance', desc: 'Service & repair records', route: '/operator/maintenance' },
      { Icon: CalendarClock, label: 'Vehicle Renewals', desc: 'Expiring vehicle docs', route: '/operator/vehicle-renewals' },
    ],
  },
  {
    title: 'Finance',
    items: [
      ...
      { Icon: FileText, label: 'Invoices', desc: 'Billing & payment tracking', route: '/operator/invoices' },
  ...
  },
  {
    title: 'Partners',
    items: [
      { Icon: Users, label: 'Customers', desc: 'Client directory & contacts', route: '/operator/customers' },
    ],
  },
];
