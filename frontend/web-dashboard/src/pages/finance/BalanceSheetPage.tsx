                    ...
                    (assets.length === 0 ? (
                      ...
                      assets.map((a) => (
                        <tr
                          key={a.account_code}
                          onClick={() =>
                            a.account_id && navigate(`/finance/general-ledger?account_id=${a.account_id}`)
                          }
                    ...
                    (liabilities.length === 0 ? (
                      ...
                      liabilities.map((l) => (
                        <tr
                          key={l.account_code}
                          onClick={() =>
                            l.account_id && navigate(`/finance/general-ledger?account_id=${l.account_id}`)
                          }
                          className="hover:bg-orange-50/40 transition-colors group cursor-pointer"
                        >
                          <td className="py-2.5 px-4"></td>
                    ...
                    (equity.length === 0 ? (
                      ...
                      equity.map((eq) => (
                        <tr
                          key={eq.account_code}
                          onClick={() =>
                            eq.account_id && navigate(`/finance/general-ledger?account_id=${eq.account_id}`)
                          }
                          className={`transition-colors group ${eq.account_id ? 'hover:bg-orange-50/40 cursor-pointer' : 'cursor-default'}`}
                        >
                          <td className="py-2.5 px-4"></td>
                          <td className="py-2.5 px-4 font-mono text-xs font-semibold text-slate-700 group-hover:text-[#FA634E]">
                            {eq.account_code}
